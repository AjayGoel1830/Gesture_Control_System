...
void printData() {
  ...
  { 
    ...
    if ( (gForceX>-Max_ang && gForceX<-Min_ang ) && (gForceY>-Min_ang && gForceY<Min_ang ))  // farward
     {
        digitalWrite(out2,LOW);  
        digitalWrite(out1,HIGH);   
        digitalWrite(out4,HIGH);   
        digitalWrite(out3,LOW);
         ...
         if ( (gForceX>Min_ang && gForceX<Max_ang) && ( gForceY>-Min_ang && gForceY<Min_ang ) )//back ward
     {
        digitalWrite(out2,HIGH);  
        digitalWrite(out1,LOW);   
        digitalWrite(out4,LOW);   
